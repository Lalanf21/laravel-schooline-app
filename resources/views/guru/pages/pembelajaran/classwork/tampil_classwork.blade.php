...
<section class="section">
    <div class="card" style="width:100%;">
        <div class="card-body">
            ...
            <a href="" data-toggle="modal" data-target="#uploadClasswork" class="btn btn-warning"> <i class="fas fa-plus"></i> Tambah Classwork</a>
        </div>
    </div>
    @if (session('status'))
    <div class="row">
            ...
            <div class="modal-body">
                <form action="{{ route('guru-panel.classwork.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        @foreach(session()->get('ruang_belajar') as $value)
