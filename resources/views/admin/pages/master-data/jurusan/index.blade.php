    ...
    <div class="row">
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin-panel.jurusan.store') }}">
                        @csrf
                        <input id="nama_jurusan" type="text" name="nama_jurusan" placeholder="Nama jurusan" autofocus value="{{ old('nama_jurusan') }}" class="form-control @error('nama_jurusan') is-invalid @enderror">
