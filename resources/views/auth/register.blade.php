    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row">
                <div class="col-lg-7 col-md-5 modal-bg-img" style="background-image: url({{ asset('/assets/img/register.png') }});">
                </div>
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        <h2 class="mt-3 text-center">Registrasi</h2>
                        <p class="text-center">Masukan data diri sesuai dengan yang terdaftar di sekolah</p>
                        @if (session('status'))
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="nisn" class="col-form-label text-md-right"> NISN </label>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="nama" class="col-form-label text-md-right">{{ __('nama') }}</label>
                                ...
                                <div class="col-lg-12 text-center mt-5">
                                    Sudah registrasi ?, klik di <a href="{{ route('login') }}">Disini</a>
                                </div>
                            </div>
                        </form>
                    </div>
